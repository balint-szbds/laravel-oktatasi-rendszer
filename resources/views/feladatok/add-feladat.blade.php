...
@section('content')
    <h1 class="text-center my-4">Új feladat létrehozása</h1>
    ...
    <form action="{{ route('store-feladat', ['id' => $id]) }}" method="post" class="card py-2 px-4">
        @csrf
        ...
        <div class="form-group">
            ...
            <input name="pont" type="text" class="form-control" >
        </div>
        <div class="form-group">
            <label for="tol">Határidő -től (ÉÉÉÉ.HH.NN ÓÓ:PP:MM)</label>
            <input name="tol" type="text" class="form-control" >
        </div>
        <div class="form-group">
